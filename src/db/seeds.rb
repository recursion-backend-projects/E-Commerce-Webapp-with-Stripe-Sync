...
#### Products ####
products = [
  { name: '夕焼けの絵画', price: 5000, stock: 10, description: '美しい夕焼けの絵画。', status: 'draft', creator: '高橋優', product_category_name: '絵画', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnu0', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTJ0' },
  ...
  { name: '夕暮れの街', price: 7500, stock: 3, description: '夕暮れ時の街の風景をリアルに描いた作品。温かみのある色彩が魅力です。', status: 'draft', creator: '山田花子', product_category_name: '絵画', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnu2', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTJ2' },
  { name: '静かな湖畔', price: 6000, stock: 4, description: '静かな湖畔の風景を描いた作品。穏やかな水面と自然の美しさが表現されています。', status: 'draft', creator: '中村太郎', product_category_name: '絵画', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnu3', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTJ3' },
  { name: '森の中', price: 4500, stock: 2, description: '森の中の風景を描いた作品。木々の緑と光の陰影が美しいです。', status: 'draft', creator: '小林美咲', product_category_name: '絵画', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnu4', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTJ4' },
  ...
  { name: '夏の海', price: 8000, stock: 1, description: '夏の海の風景を描いた作品。青い海と空の広がりが印象的です。', status: 'draft', creator: '松本真理', product_category_name: '絵画', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnu6', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTJ6' },
  ...
  { name: '大理石の彫刻', price: 15000, stock: 5, description: '詳細な大理石の彫刻。', status: 'draft', creator: '斎藤一郎', product_category_name: '彫刻', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnv0', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTK0' },
  ...
  { name: '石の彫刻', price: 8000, stock: 6, description: '石で作られた手作りの彫刻。', status: 'draft', creator: '小林美咲', product_category_name: '彫刻', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnv4', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTK4' },
  ...
  { name: 'ガラスの彫刻', price: 15000, stock: 3, description: '透明感のあるガラスの彫刻。', status: 'draft', creator: '石田昇', product_category_name: '彫刻', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnv7', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTK7' },
  ...
  { name: '紙の彫刻', price: 5000, stock: 7, description: '紙で作られた繊細な彫刻。', status: 'draft', creator: '藤井剛', product_category_name: '彫刻', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnv9', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTK9' },
  { name: '白黒写真', price: 3000, stock: 20, description: 'クラシックな白黒写真。', status: 'draft', creator: '藤井剛', product_category_name: '写真', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnw0', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTL0' },
  ...
  { name: '雪山の頂', price: 5000, stock: 0, description: '雪山の頂を捉えた写真。', status: 'draft', creator: '山田花子', product_category_name: '写真', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnw3', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTL3' },
  ...
  { name: '春の花', price: 4500, stock: 12, description: '春の花が咲き乱れる花の写真。', status: 'draft', creator: '小林美咲', product_category_name: '写真', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnw5', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTL5' },
  ...
  { name: '冬の夜空', price: 3200, stock: 0, description: '冬の夜空に輝く星々の写真。', status: 'draft', creator: '高橋優', product_category_name: '写真', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnw7', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTL7' },
  { name: '海岸の朝', price: 3700, stock: 11, description: '朝の海岸の風景を捉えた写真。', status: 'draft', creator: '石田昇', product_category_name: '写真', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnw8', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTL8' },
  ...
  { name: '夢見る少年', price: 4500, stock: 10, description: '夢の中で冒険する少年を描いたイラスト。', status: 'draft', creator: '青木涼', product_category_name: 'イラスト', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnx1', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTM1' },
  { name: '魔法の森', price: 5000, stock: 8, description: '魔法の森を舞台にした幻想的なイラスト。', status: 'draft', creator: '高田春', product_category_name: 'イラスト', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnx2', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTM2' },
  ...
  { name: '銀河の旅', price: 5500, stock: 7, description: '銀河を旅する冒険者たちを描いたイラスト。', status: 'draft', creator: '中田秋', product_category_name: 'イラスト', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnx4', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTM4' },
  ...
  { name: '妖精の森', price: 4800, stock: 9, description: '妖精が住む森を描いた可愛らしいイラスト。', status: 'draft', creator: '西田光', product_category_name: 'イラスト', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnx6', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTM6' },
  ...
  { name: '異世界の冒険者', price: 5800, stock: 0, description: '異世界で冒険する勇者たちを描いたイラスト。', status: 'draft', creator: '藤原優', product_category_name: 'イラスト', product_type: 1, stripe_product_id: 'prod_QASQuJHkOEtVnx9', stripe_price_id: 'price_1PK7Vj2KrybDMqMJUZMhUUTM9' }
]
