  ...
  describe 'product' do
    ...
    context 'when validating name' do
      it 'is valid with a name' do
        name = 'a' * 250
        product = described_class.new(name:, product_type: 'physics')
        expect(product).to be_valid
      end

      it 'is invalid without a name' do
        product = described_class.new(name: nil, product_type: 'physics')
        product.valid?
    ...
    context 'when validating price' do
      it 'is valid with a blank price' do
        product = build(:product, product_type: 'physics')
        product.price = nil
        expect(product).to be_valid
